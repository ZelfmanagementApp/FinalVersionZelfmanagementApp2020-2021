...
class VervolgHormoontherapie extends StatefulWidget {
  @override
  VervolgHormoontherapieState createState() =>
      new VervolgHormoontherapieState();
}

class VervolgHormoontherapieState extends State<VervolgHormoontherapie> {
