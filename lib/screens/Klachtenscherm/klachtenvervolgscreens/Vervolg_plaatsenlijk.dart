...
class VervolgPlaatsenlijk extends StatefulWidget {
  @override
  VervolgPlaatsenlijkState createState() => new VervolgPlaatsenlijkState();
}

class VervolgPlaatsenlijkState extends State<VervolgPlaatsenlijk> {
