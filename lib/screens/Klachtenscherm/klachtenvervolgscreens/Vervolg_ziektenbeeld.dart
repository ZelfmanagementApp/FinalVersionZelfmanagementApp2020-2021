...
class VervolgZiektenbeeld extends StatefulWidget {
  @override
  VervolgZiektenbeeldState createState() => new VervolgZiektenbeeldState();
}

class VervolgZiektenbeeldState extends State<VervolgZiektenbeeld> {
