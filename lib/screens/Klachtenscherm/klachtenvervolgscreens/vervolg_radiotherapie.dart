...
class VervolgRadiotherapie extends StatefulWidget {
  @override
  VervolgRadiotherapieState createState() => new VervolgRadiotherapieState();
}

class VervolgRadiotherapieState extends State<VervolgRadiotherapie> {
