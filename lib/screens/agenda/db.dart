//Even voor het onthouden van de gegevens gemaakt.
...
abstract class DB {
  ...
  static Future<int> insert(String table, AgendaItem item) async =>
      await _db.insert(table, item.toMap());

  static Future<int> delete(String table, AgendaItem item) async =>
